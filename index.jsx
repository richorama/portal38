...
render(<Page><Panel title="hello"><div>Hello World</div></Panel></Page>)

routie('/server', () => {
  render(<Page activeMenuItem="#/server"><Server /></Page>)
})

routie('/keys', () => {
  render(<Page activeMenuItem="#/keys"><Keys /></Page>)
})

routie('/keys/:key', key => {
  render(<Page activeMenuItem="#/keys"><Key keyName={key} /></Page>)
})
